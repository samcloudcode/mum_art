      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {prints.map((print, index) => {
          ...
          return (
            ...
            >
              {/* Artwork thumbnail */}
              <div className="relative aspect-square mb-4 -mx-6 -mt-6 overflow-hidden rounded-t-sm bg-muted">
                {print.primary_image_path ? (
                  <Image
                    src={getThumbnailUrl(print.primary_image_path, { width: 400, height: 400 }) || ''}
                    alt={print.name}
                    fill
